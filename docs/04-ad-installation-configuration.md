...
### Step 3.1: Post-Installation Verification and DNS Reconfiguration
...
### Step 3.2: Creating Organizational Units (OUs) separated by Department
...
### Step 3.3: Creating User for the User OU
